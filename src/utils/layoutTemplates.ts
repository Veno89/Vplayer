...
export const LAYOUT_TEMPLATES: Record<string, LayoutTemplate> = {
  classic: {
    ...
    windows: {
      player: { x: 40, y: 40, width: 400, height: 420, visible: true, minimized: false },
      equalizer: { x: 40, y: 480, width: 400, height: 380, visible: true, minimized: false },
      playlist: { x: 460, y: 40, width: 480, height: 820, visible: true, minimized: false },
      library: { x: 960, y: 40, width: 450, height: 500, visible: false, minimized: false },
      visualizer: { x: 460, y: 880, width: 480, height: 180, visible: false, minimized: false },
  ...
  full: {
    ...
    windows: {
      player: { x: 20, y: 20, width: 380, height: 420, visible: true, minimized: false },
      equalizer: { x: 20, y: 460, width: 380, height: 380, visible: true, minimized: false },
      playlist: { x: 420, y: 20, width: 400, height: 500, visible: true, minimized: false },
      visualizer: { x: 420, y: 540, width: 400, height: 300, visible: true, minimized: false },
      library: { x: 840, y: 20, width: 400, height: 820, visible: true, minimized: false },
      queue: { x: 840, y: 540, width: 400, height: 300, visible: false, minimized: false },
      discography: { x: 790, y: 340, width: 450, height: 500, visible: false, minimized: false },
    }
  },
  ...
  playlistFocus: {
    ...
    windows: {
      player: { x: 20, y: 20, width: 800, height: 420, visible: true, minimized: false },
      playlist: { x: 20, y: 460, width: 800, height: 380, visible: true, minimized: false },
      library: { x: 860, y: 40, width: 450, height: 500, visible: false, minimized: false },
      equalizer: { x: 860, y: 40, width: 400, height: 380, visible: false, minimized: false },
      visualizer: { x: 40, y: 900, width: 800, height: 180, visible: false, minimized: false },
  ...
  djMode: {
    ...
    windows: {
      player: { x: 20, y: 20, width: 420, height: 420, visible: true, minimized: false },
      equalizer: { x: 20, y: 460, width: 420, height: 380, visible: true, minimized: false },
      visualizer: { x: 460, y: 20, width: 400, height: 300, visible: true, minimized: false },
      queue: { x: 460, y: 340, width: 400, height: 500, visible: true, minimized: false },
  ...
  libraryBrowser: {
    ...
    windows: {
      ...
      player: { x: 580, y: 40, width: 380, height: 420, visible: true, minimized: false },
      playlist: { x: 580, y: 480, width: 380, height: 380, visible: true, minimized: false },
      equalizer: { x: 580, y: 880, width: 380, height: 380, visible: false, minimized: false },
      visualizer: { x: 40, y: 880, width: 520, height: 180, visible: false, minimized: false },
  ...
  visualizerMode: {
    ...
    windows: {
      visualizer: { x: 20, y: 20, width: 820, height: 380, visible: true, minimized: false },
      player: { x: 20, y: 420, width: 420, height: 420, visible: true, minimized: false },
      equalizer: { x: 460, y: 420, width: 380, height: 420, visible: true, minimized: false },
  ...
  mini: {
    ...
    windows: {
      ...
      equalizer: { x: 40, y: 480, width: 420, height: 380, visible: false, minimized: false },
  ...
  compact: {
    ...
    windows: {
      ...
      library: { x: 960, y: 40, width: 450, height: 500, visible: false, minimized: false },
      equalizer: { x: 40, y: 540, width: 400, height: 380, visible: false, minimized: false },
