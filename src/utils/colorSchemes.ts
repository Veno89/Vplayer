 ...
 * Single source of truth for all color schemes used across the app
 */
export const COLOR_SCHEMES = {
  ...
  sunset: { 
    ...
    primary: 'bg-linear-to-r from-orange-500 to-pink-500',
  ...
  ocean: { 
    ...
    primary: 'bg-linear-to-r from-cyan-500 to-blue-500',
  ...
  forest: { 
    ...
    primary: 'bg-linear-to-r from-emerald-500 to-lime-500',
  ...
  synthwave: { 
    ...
    primary: 'bg-linear-to-r from-fuchsia-500 to-cyan-400',
...
/**
 * Simplified color scheme list for UI picker (AppearanceTab)
 */
export const COLOR_SCHEME_LIST = Object.values(COLOR_SCHEMES).map(scheme => ({
  name: scheme.name,
  label: scheme.label,
  background: scheme.background,
  backgroundSecondary: scheme.backgroundSecondary,
  color: scheme.color,
  isGradient: scheme.primary?.includes('gradient'),
  gradient: scheme.primary?.includes('gradient') ? scheme.primary.replace('bg-', '') : undefined,
}));
