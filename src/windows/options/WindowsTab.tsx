...
const WINDOW_COLORS: Record<string, { bg: string; text: string; border: string }> = {
...
export function WindowsTab({ windows, toggleWindow }: WindowsTabProps) {
  ...
  const formatWindowName = (id: string) => {
