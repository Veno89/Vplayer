 ...
 */
export function SettingToggle({ label, description, checked, onChange, icon: Icon, accentColor }) {
 ...
 */
export function SettingSelect({ label, description, value, onChange, options, icon: Icon }) {
  return (
    <div className="p-4 rounded-xl border border-slate-700/50 bg-slate-800/20">
 ...
 */
export function SettingSection({ title, icon: Icon, children, description }) {
  return (
 ...
 */
export function SettingCard({ title, icon: Icon, children, accent = 'cyan' }) {
  return (
 ...
 */
export function SettingButton({ label, description, onClick, icon: Icon, variant = 'default', loading = false }) {
  const variants = {
 ...
 */
export function SettingInfo({ label, value, icon: Icon }) {
  return (
 ...
 */
export function SettingDivider({ label }) {
  if (label) {
    return (
 ...
 * Badge/tag component
 */
export function SettingBadge({ children, variant = 'default' }) {
  const variants = {
