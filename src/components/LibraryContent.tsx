      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button 
            ...
            disabled={isScanning}
            className={`px-3 py-1 bg-blue-700 text-white text-xs rounded-sm hover:bg-blue-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed`}
          >
            Add Folder
          </button>
        </div>
      ...
      <div className="flex flex-col gap-2">
        {libraryFolders.length === 0 ? (
          ...
          libraryFolders.map((folder, idx) => (
            <div key={folder.path || idx} className="flex items-center justify-between bg-slate-800 px-3 py-2 rounded-sm">
              ...
              <button 
                ...
                disabled={isScanning}
                className="ml-2 px-2 py-1 bg-red-700 text-white text-xs rounded-sm hover:bg-red-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Remove
              </button>
            </div>
